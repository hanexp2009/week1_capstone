...
print("label,duration,snr_db,expected,predicted,best_count,second_count,ratio")
...
for label, samples, sample_rate, expected in tests:
    for duration in durations:
        ...
        for snr in snrs:
            ...
            print(f"{label},{duration},{snr},{expected},{best_song},{best_count},{second_count},{ratio:.2f}")